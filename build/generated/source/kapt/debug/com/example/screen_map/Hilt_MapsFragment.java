...
public abstract class Hilt_MapsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MapsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MapsFragment_GeneratedInjector) this.generatedComponent()).injectMapsFragment(UnsafeCasts.<MapsFragment>unsafeCast(this));
    }
  }
